    ...
    def _compare_dates(self) -> List[Dict[str, Any]]:
        ...
        if seulement_pacte:
            incoherences.append({
                "type": "date",
                "severite": "alerte",
                "description": f"Date(s) présente(s) dans le pacte mais absente(s) des statuts : {', '.join(sorted(seulement_pacte))}.",
        ...
        if seulement_statuts:
            incoherences.append({
                "type": "date",
                "severite": "alerte",
                "description": f"Date(s) présente(s) dans les statuts mais absente(s) du pacte : {', '.join(sorted(seulement_statuts))}.",
    ...
    def _compare_montants(self) -> List[Dict[str, Any]]:
        ...
        if valeurs_pacte.issubset(valeurs_statuts) or valeurs_statuts.issubset(valeurs_pacte):
            ...
            incoherences.append({
                "type": "montant",
                "severite": "bloquant",
                "description": "Les montants mentionnés dans le pacte et les statuts diffèrent.",
                "valeur_pacte": ", ".join(sorted(valeurs_pacte)),
                "valeur_statuts": ", ".join(sorted(valeurs_statuts)),
                "document_reference": "",
            })
